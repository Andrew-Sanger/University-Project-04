...
public class LMSFacade implements LMSModel {
	...
	// This method first retrieves all holdings from the library, and then
	// checks whether the holding is an instance of Book, and if so, increments
	// the count by 1
	@Override
	...
	// This method first retrieves all holdings from the library, and then
	// checks whether the holding is an instance of Video, and if so, increments
	// the count by 1
	@Override
